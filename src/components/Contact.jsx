      ...
      <div className="contact-minimal-grid">
        ...
        >
          <div className="minimal-links">
            ...
            <a href="https://www.linkedin.com/in/nirvaanearthlab" target="_blank" rel="noopener noreferrer"><LinkedInIcon />nirvaanearthlab</a>
            <a href="https://x.com/NirvaanEarthlab" target="_blank" rel="noopener noreferrer"><TwitterIcon />NirvaanEarthlab</a>
            <a href="https://www.instagram.com/nirvaan.earthlab/" target="_blank" rel="noopener noreferrer"><InstagramIcon />nirvaan.earthlab</a>
          </div>
        </motion.div>
        <motion.div 
