...
const CurrentWeatherCard = ({ current }) => {
    ...
    <div className="w-card">
      ...
      <div className="current-stats-grid">
        <div className="stat-item">
          ...
          <span className="stat-value">{Math.round(current.main.feels_like)}°C</span>
        </div>
        <div className="stat-item">
        ...
        <div className="stat-item">
          ...
          <span className="stat-value">{current.wind.speed} m/s</span>
        </div>
        <div className="stat-item">
        ...
        <div className="stat-item">
          ...
          <span className="stat-value">{(current.visibility / 1000).toFixed(1)} km</span>
        </div>
        <div className="stat-item">
          <span className="stat-label"><Sunrise size={16} /> Sunrise</span>
          <span className="stat-value">{formatTime(current.sys.sunrise)}</span>
        </div>
      </div>
    </div>
  );
